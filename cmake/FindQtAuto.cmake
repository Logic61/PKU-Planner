...
if(DEFINED ENV{Qt6_DIR})
    set(_env_qt6_dir "$ENV{Qt6_DIR}")
    if(EXISTS "${_env_qt6_dir}/Qt6Config.cmake")
        message(STATUS "[FindQtAuto] Qt6_DIR env detected: ${_env_qt6_dir}, using it.")
        set(Qt6_DIR "${_env_qt6_dir}" CACHE PATH "Qt6 CMake directory" FORCE)
        return()
    elseif(EXISTS "${_env_qt6_dir}/lib/cmake/Qt6/Qt6Config.cmake")
        message(STATUS "[FindQtAuto] Qt6_DIR env detected: ${_env_qt6_dir}, using lib/cmake/Qt6.")
        set(Qt6_DIR "${_env_qt6_dir}/lib/cmake/Qt6" CACHE PATH "Qt6 CMake directory" FORCE)
        return()
    endif()
endif()
